...
<body>
	...
	<div class="container">
		...
		<form action="uploadProduct" method="post">
			...
			<label>Product Quantity</label> <input type="text" name="qty">

			<label>Product Description</label> <input type="text"
				name="description"> <label>Sold By</label> <input
				type="text" name="soldBy"> <label>Product Price</label> <input
				type="text" name="price"> <label>Type</label> 
				<select
				name="priceType">
